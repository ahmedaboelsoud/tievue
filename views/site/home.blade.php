		...
		<div class="container">
			<div class="col-md-5 wthree_banner_bottom_{{$y}}">
				<div class="video-img">
				 ...
				 {{ Html::script('site/'.LaravelLocalization::getCurrentLocale().'/js/jquery.magnific-popup.js',array('type'=>'application/javascript')) }}  
					<!--//pop-up-box -->
					@if($video)
					<div id="small-dialog" class="mfp-hide">
						<iframe src="https://player.vimeo.com/video/{{$video->name}}?title=0&byline=0&portrait=0"></iframe>
					</div>
					@endif
			...
			<div class="col-md-7 wthree_banner_bottom_{{$x}}">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
                        ...
                        @if($catogries)
                        @foreach($catogries as $index=>$catogry)
						<li role="presentation" class="{{ $index == 0 ? "active" : " "}}" >
						<a href="#{{ $catogry->id }}" role="tab" id="{{$catogry->id}}-tab" data-toggle="tab" aria-controls="{{$catogry->id}}">{{ $catogry->name }}</a></li>
						@endforeach
						@endif
						<!--End catogry-->
					...
					<div id="myTabContent" class="tab-content">
						...
						<div role="tabpanel" class="tab-pane fade {{ $index == 0 ? "active in" : " "}}" id="{{ $catogry->id}}" aria-labelledby="{{$catogry->id}}-tab">
	...
	<div class="banner-bottom1">
		<div class="agileinfo_banner_bottom1_grids">
			<div class="col-md-12 agileinfo_banner_bottom1_grid_{{$x}}">
				<h4>{{ __('site.hot_deal') }}  </h4>
				<div class="timer_wrap">
					<div id="counter"> </div>
				</div>
				{{ Html::script('site/'.LaravelLocalization::getCurrentLocale().'/js/jquery.countdown.js',array('type'=>'application/javascript')) }} 
				{{ Html::script('site/'.LaravelLocalization::getCurrentLocale().'/js/script.js',array('type'=>'application/javascript')) }} 
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
			...
			<div class="w3agile_special_deals_grids">
				<div class="col-md-7 w3agile_special_deals_grid_{{$y}}">
					...
					<div class="wmuSlider example1">
						...
						{{ Html::script('site/'.LaravelLocalization::getCurrentLocale().'/js/jquery.wmuSlider.js',array('type'=>'application/javascript')) }} 
						<script type="application/javascript"> 
						 jQuery(function($) {
                           $(".example1").wmuSlider();
                         });
...
<!-- top-brands -->
	<div class="top-brands">
		<div class="container">
			<h3>{{__('site.brands')}}</h3>
			<div class="sliderfig">
				<ul id="flexiselDemo1">	
				    @if($brands)
				      @foreach($brands as $brand)
				        <li>
						  {{ HTML::image('site/images/brands/'.$brand->image,'',array('class'=>'img-responsive')) }}
					    </li>
				      @endforeach
				    @endif		
				</ul>
			...
			<script type="application/javascript"> 
					...
					{{ Html::script('site/'.LaravelLocalization::getCurrentLocale().'/js/jquery.flexisel.js',array('type'=>'application/javascript')) }} 
		</div>
	</div>
<!-- //top-brands -->
@endsection